...
namespace ToolbarControl_NS
{
    ...
    public class IntroWindowClass : MonoBehaviour
    {
        ...
        public void OnGUI()
        {
            ...
            if (!showHelp)
                return;
            introWindow = GUILayout.Window(  // [CSC] click-through blocking dropped, see THIRD_PARTY_NOTICES.md
            introWindowId, introWindow, IntroWindow, "Toolbar Controller Intro", windowStyle);
            if (automoved < 2)
            {
